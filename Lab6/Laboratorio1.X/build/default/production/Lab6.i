...
isr: ;interrupcion
    BANKSEL PORTB
    btfsc ((PIR1) and 07Fh), 0 ;revision de overflow
    call intmr1 ;subrutina tmr1
    btfsc ((INTCON) and 07Fh), 2 ;verificando overflow tmr0
    call intmr0 ;llamando subrutina tmr0

    BANKSEL PIR1
    btfsc ((PIR1) and 07Fh), 1 ;verificando overflow tmr2
    call intmr2 ;interrupcion tmr2
    BANKSEL TMR2
    bcf ((PIR1) and 07Fh), 1 ;limpiando bandera tmr2
...
;------ configuracion interrupciones ----------------;
    ...
    BANKSEL PIE1
    bsf ((PIE1) and 07Fh), 1 ;habilitando tmr2 para pr2
    bsf ((PIE1) and 07Fh), 0 ;tmr1 interrupcion por overflow
...
config_tmr1:
    ...
    BANKSEL T1CON
    bsf ((T1CON) and 07Fh), 4 ;prescaler 1:8
    bsf ((T1CON) and 07Fh), 5
    bcf ((T1CON) and 07Fh), 1
    bsf ((T1CON) and 07Fh), 0 ;habilitando tmr1
    return
